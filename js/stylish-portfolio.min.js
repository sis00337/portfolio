...
let div = document.querySelectorAll('.caption');
let project = document.querySelectorAll('.caption-content')
// let show = true;
div[0].addEventListener('mouseover', function(event) {
    project[0].style.display = 'block';
});
div[0].addEventListener('mouseout', function(event) {
    project[0].style.display = 'none';
});
div[1].addEventListener('mouseover', function(event) {
    project[1].style.display = 'block';
});
div[1].addEventListener('mouseout', function(event) {
    project[1].style.display = 'none';
});
div[2].addEventListener('mouseover', function(event) {
    project[2].style.display = 'block';
});
div[2].addEventListener('mouseout', function(event) {
    project[2].style.display = 'none';
});
div[3].addEventListener('mouseover', function(event) {
    project[3].style.display = 'block';
});
div[3].addEventListener('mouseout', function(event) {
